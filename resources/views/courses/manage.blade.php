                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <form action="" method="get">
                                                        ...
                                                        <button type="submit" style="background-color: transparent;border:none;margin-left:10%;color:white;" ><a>{{$video->title}}</a></button> 
                                                    </form>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <form action="" method="get">
                                                    <input type="hidden" name="play_id" value="{{$video->id}}">
                                                    {{$views->where('video_id',$video->id)->count()}} Views
                                                    <button type="submit" style="background-color: transparent;border:none;margin-left:10%;" ><a>{{$video->title}}</a></button>
                                                </form>
